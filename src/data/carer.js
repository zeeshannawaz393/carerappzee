...
export const OBSERVATION_TYPES = [
  ...
  { id: 'pulse', name: 'Pulse', icon: 'heart', group: 'Vital signs',
  ...
  { id: 'respirations', name: 'Respiratory rate', icon: 'activity', group: 'Vital signs',
    fields: [{ key: 'value', label: 'Breaths per minute', type: 'number', unit: '/min', required: true, min: 4, max: 60, normalMin: 12, normalMax: 20 }] },
  { id: 'bp', name: 'Blood pressure', icon: 'activity', group: 'Vital signs',
  ...
  { id: 'spo2', name: 'Oxygen saturation', icon: 'droplet', group: 'Vital signs',
  ...
  { id: 'news2', name: 'NEWS2 score', icon: 'scale', group: 'Vital signs',
  ...
  { id: 'pain', name: 'Pain score', icon: 'activity', group: 'Wellbeing',
  ...
  { id: 'sleep', name: 'Sleep', icon: 'clock', group: 'Wellbeing',
  ...
  { id: 'seizure', name: 'Seizure', icon: 'activity', group: 'Other',
  ...
  { id: 'fluid', name: 'Fluid intake', icon: 'droplet', group: 'Intake & output',
  ...
  { id: 'food', name: 'Food / nutrition', icon: 'utensils', group: 'Intake & output',
  ...
  { id: 'bowel', name: 'Bowels (Bristol)', icon: 'refuse', group: 'Intake & output',
  ...
  { id: 'reposition', name: 'Repositioning', icon: 'footprints', group: 'Skin & mobility',
  ...
  { id: 'skin', name: 'Skin / body map', icon: 'activity', group: 'Skin & mobility',
  ...
  { id: 'weight', name: 'Weight', icon: 'scale', group: 'Other',
