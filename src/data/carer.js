...
export const OBSERVATION_TYPES = [
  ...
  { id: 'bp', name: 'Blood pressure', icon: 'target', group: 'Vital signs',
  ...
  { id: 'pain', name: 'Pain score', icon: 'flag', group: 'Wellbeing',
  ...
  { id: 'skin', name: 'Skin / body map', icon: 'map-pin', group: 'Skin & mobility',
